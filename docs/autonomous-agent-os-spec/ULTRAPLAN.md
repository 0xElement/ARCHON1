...
Net-new unless noted: `ARCHON/paths.js` (modify), `ARCHON/src/shadow/shadow-sink.js`, `ARCHON/src/core/engagement-mode.js`, `ARCHON/common/schemas/`, `ARCHON/common/patterns/`, `ARCHON/src/intel/knowledge-graph.js`, `ARCHON/src/intel/pattern-catalog.js`, `ARCHON/src/orchestrator/mission-director.js`, `ARCHON/src/dispatch/whitebox-correlation.js`, `ARCHON/src/pipeline/correlation-records.js`, `ARCHON/src/pipeline/report-stream.js`; modify: `ARCHON/event-bus.js`, `ARCHON/scripts/dashboard.js`, `ARCHON/src/dispatch/code-review-dispatcher.js`, `ARCHON/src/pipeline/pentest-phases.js` (PHASE_MANIFEST 3.088/3.95), `ARCHON/agents/finding-schema.js`, `ARCHON/agents/judge-verifier.js`, `ARCHON/agents/poc-evidence-capture.js`, `ARCHON/src/pipeline/{cross-view-dedup,evidence-completeness,attack-planner,attack-graph}.js`, `ARCHON/src/core/coverage-map.js`, `ARCHON/scripts/run-judge-verifier.js`, `ARCHON/agents/auditor-validated-builder.js` (terminal-hop annotation re-run wiring, Issue 7).
