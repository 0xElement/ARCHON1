...
function buildRecord(args) {
  ...
  const rec = {
    ...
    method: args.method && args.method !== true ? String(args.method).toUpperCase() : '',
    ...
    remediation: args.remediation && args.remediation !== true ? String(args.remediation) : '',
    validation: readMaybeFile(args.validation, args['validation-file']),
    raw_request: readMaybeFile(args['raw-request'], args['raw-request-file']),
